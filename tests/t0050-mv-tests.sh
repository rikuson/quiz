...
test_expect_success 'Basic move command' '
	...
	"$QUIZ" mv cred1 cred2 &&
	[[ -e $QUIZ_STORE_DIR/cred2.gpg && ! -e $QUIZ_STORE_DIR/cred1.gpg ]]
'

test_expect_success 'Directory creation' '
	"$QUIZ" mv cred2 directory/ &&
	[[ -d $QUIZ_STORE_DIR/directory && -e $QUIZ_STORE_DIR/directory/cred2.gpg ]]
'
...
test_expect_success 'Directory creation with file rename and empty directory removal' '
	...
	[[ -d $QUIZ_STORE_DIR/"new directory with spaces" && -e $QUIZ_STORE_DIR/"new directory with spaces"/cred.gpg && ! -e $QUIZ_STORE_DIR/directory ]]
'

test_expect_success 'Directory rename' '
	"$QUIZ" mv "new directory with spaces" anotherdirectory &&
	[[ -d $QUIZ_STORE_DIR/anotherdirectory && -e $QUIZ_STORE_DIR/anotherdirectory/cred.gpg && ! -e $QUIZ_STORE_DIR/"new directory with spaces" ]]
'

test_expect_success 'Directory move into new directory' '
	"$QUIZ" mv anotherdirectory "new directory with spaces"/ &&
	[[ -d $QUIZ_STORE_DIR/"new directory with spaces"/anotherdirectory && -e $QUIZ_STORE_DIR/"new directory with spaces"/anotherdirectory/cred.gpg && ! -e $QUIZ_STORE_DIR/anotherdirectory ]]
'
...
test_expect_success 'Multi-directory creation and multi-directory empty removal' '
	...
	[[ ! -d $QUIZ_STORE_DIR/"new directory with spaces"/anotherdirectory && ! -d $QUIZ_STORE_DIR/new1/new2/new3/new4 && -e $QUIZ_STORE_DIR/cred.gpg ]]
'
